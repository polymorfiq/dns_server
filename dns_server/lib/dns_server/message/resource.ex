defmodule DnsServer.Message.Resource do
  ...
  @moduledoc """
  Defines an internal representation of a DNS Resource Record, given by the DNS RFC
  RFC: https://www.rfc-editor.org/rfc/rfc1035#section-4.1.3
  """
  ...
  @doc """
  Converts from a human-readable Resource Records to the byte format defined in the DNS RFC
  """
  ...
  @doc """
  Pops multiple instances of `DnsServer.Message.Resource` off the top of a bitstring that follows the byte format defined by the DNS RFC
  """
  ...
  @doc """
  Gives the real length of `rddata` (if it came out-of-sync with the RDATA bitstring)
  """
