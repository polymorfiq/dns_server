defmodule DnsServer.Message.Parsing do
  @moduledoc """
  A set of helper functions for converting between byte formats and human readable formats.

  For example: `<domain-names>` and `<character-strings>` defined in the DNS RFC.
  RFC: https://www.rfc-editor.org/rfc/rfc1035#section-5.1
  """
  ...
  @doc """
  Converts an `<internet-address>` bitstring to a human-readable IP address
  """
  ...
  @doc """
  Converts a human-readable IP address to a set of bytes as defined by the DNS RFC
  """
  ...
  @doc """
  Converts a set of bytes to a human-readable representation of a <character-string>
  """
  ...
  @doc """
  Converts a human-readable representation of a <domain-name> to a set of bytes defined by the DNS RFC
  """
  ...
  @doc """
  Converts a human-readable <domain-name> to the byte format defined by the DNS RFC
  """
  ...
  @doc """
  Pops a <domain-name> off the top of a bitstring that follows the byte format defined in the DNS RFC
  """
